...
# Requires: target "Mangogram" and function "nice_target_sources" to exist.
...
nice_target_sources(Mangogram ${_qsb_out_dir}
PRIVATE
    shaders.qrc
)
add_dependencies(Mangogram compile_shaders)
