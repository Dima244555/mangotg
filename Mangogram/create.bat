...
(
  ...
  (
    echo /*
    echo This file is part of Mangogram Desktop,
    echo the official desktop application for the Mangogram messaging service.
    echo.
    echo For license and copyright information please follow this link:
    echo https://github.com/mangogramdesktop/tdesktop/blob/master/LEGAL
    echo */
  )> "SourceFiles\!Path!"
  exit /b
)
