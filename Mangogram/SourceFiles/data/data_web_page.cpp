...
WebPageType ParseWebPageType(
	...
	} else if (type == u"mangogram_background"_q) {
		return WebPageType::WallPaper;
	} else if (type == u"mangogram_theme"_q) {
		return WebPageType::Theme;
	} else if (type == u"mangogram_story"_q) {
		return WebPageType::Story;
	} else if (type == u"mangogram_channel"_q) {
		return WebPageType::Channel;
	} else if (type == u"mangogram_channel_request"_q) {
		return WebPageType::ChannelWithRequest;
	} else if (type == u"mangogram_megagroup"_q
		|| type == u"mangogram_chat"_q) {
		return WebPageType::Group;
	} else if (type == u"mangogram_megagroup_request"_q
		|| type == u"mangogram_chat_request"_q) {
		return WebPageType::GroupWithRequest;
	} else if (type == u"mangogram_album"_q) {
		return WebPageType::Album;
	} else if (type == u"mangogram_message"_q) {
		return WebPageType::Message;
	} else if (type == u"mangogram_bot"_q) {
		return WebPageType::Bot;
	} else if (type == u"mangogram_voicechat"_q) {
		return WebPageType::VoiceChat;
	} else if (type == u"mangogram_livestream"_q) {
		return WebPageType::Livestream;
	} else if (type == u"mangogram_call"_q) {
		return WebPageType::ConferenceCall;
	} else if (type == u"mangogram_user"_q) {
		return WebPageType::User;
	} else if (type == u"mangogram_botapp"_q) {
		return WebPageType::BotApp;
	} else if (type == u"mangogram_channel_boost"_q) {
		return WebPageType::ChannelBoost;
	} else if (type == u"mangogram_group_boost"_q) {
		return WebPageType::GroupBoost;
	} else if (type == u"mangogram_giftcode"_q) {
		return WebPageType::Giftcode;
	} else if (type == u"mangogram_stickerset"_q) {
		return WebPageType::StickerSet;
	} else if (type == u"mangogram_story_album"_q) {
		return WebPageType::StoryAlbum;
	} else if (type == u"mangogram_collection"_q) {
		return WebPageType::GiftCollection;
	} else if (type == u"mangogram_auction"_q) {
		return WebPageType::Auction;
	} else if (type == u"mangogram_newbot"_q) {
		return WebPageType::NewBot;
	} else if (type == u"mangogram_aicomposetone"_q) {
