...
inline QString PassportCorrupted() {
	return u"It seems your Mangogram Passport data was corrupted.\n\nYou can reset your Mangogram Passport and restart this authorization."_q;
}

inline QString PassportCorruptedChange() {
	return u"It seems your Mangogram Passport data was corrupted.\n\nYou can reset your Mangogram Passport and change your cloud password."_q;
}
...
inline QString PassportCorruptedResetSure() {
	return u"Are you sure you want to reset your Mangogram Passport data?"_q;
}
