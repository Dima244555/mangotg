...
rpl::producer<TextWithEntities> Text1() {
	return tr::lng_about_text1(
		lt_api_link,
		tr::lng_about_text1_api(tr::url(u"https://core.mangogram.org/api"_q)),
		tr::marked);
}
...
rpl::producer<TextWithEntities> Text2() {
	return tr::lng_about_text2(
		...
		rpl::single(tr::link(
			"GNU GPL",
			"https://github.com/mangogramdesktop/tdesktop/blob/master/LICENSE")),
		lt_github_link,
		rpl::single(tr::link(
			"GitHub",
			"https://github.com/mangogramdesktop/tdesktop")),
		tr::marked);
}
...
rpl::producer<TextWithEntities> Text3() {
	return tr::lng_about_text3(
		lt_faq_link,
		tr::lng_about_text3_faq(tr::url(mangogramFaqLink())),
		tr::marked);
}
...
void AboutBox(not_null<Ui::GenericBox*> box) {
	box->setTitle(u"Mangogram Desktop"_q);
		...
		if (cRealAlphaVersion()) {
			...
			box->getDelegate()->show(
				Ui::MakeInformBox(
					...
					"version of Mangogram Desktop was copied "
					"to the clipboard."));
		} else {
...
QString mangogramFaqLink() {
	const auto result = u"https://mangogram.org/faq"_q;
