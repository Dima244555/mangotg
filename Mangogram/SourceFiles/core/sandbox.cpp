...
int Sandbox::start() {
	...
	// https://github.com/mangogramdesktop/tdesktop/issues/948
	// and https://github.com/mangogramdesktop/tdesktop/issues/5022
...
void Sandbox::socketError(QLocalSocket::LocalSocketError e) {
	...
	if (e == QLocalSocket::ServerNotFoundError) {
		LOG(("This is the only instance of Mangogram, starting server and app..."));
	} else {
