...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Mangogram.MangogramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Mangogram.MangogramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Mangogram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Mangogram Desktop/Mangogram.lnk"_q;
	const auto old = u"Mangogram Win (Unofficial)/Mangogram.lnk"_q;
