...
NSString *const kMangogramMarkAsReadText = @"MangogramMarkAsReadText";
NSString *const kMangogramMarkAsReadTimestamp = @"MangogramMarkAsReadTimestamp";
NSString *const kMangogramMarkAsReadLanguageCode = @"MangogramMarkAsReadLanguageCode";
...
void Manager::Private::initCachedMarkAsReadText() {
	...
	const auto cachedText = static_cast<NSString*>([defaults
		stringForKey:kMangogramMarkAsReadText]);
	const auto cachedTimestamp = static_cast<NSNumber*>([defaults
		objectForKey:kMangogramMarkAsReadTimestamp]);
	const auto cachedLanguageCode = static_cast<NSString*>([defaults
		stringForKey:kMangogramMarkAsReadLanguageCode]);
	...
	if (langId == NS2QString(languageCode)) {
		[defaults
			...
			forKey:kMangogramMarkAsReadText];
		[defaults
			setObject:@(base::unixtime::now())
			forKey:kMangogramMarkAsReadTimestamp];
		[defaults
			setObject:languageCode
			forKey:kMangogramMarkAsReadLanguageCode];
