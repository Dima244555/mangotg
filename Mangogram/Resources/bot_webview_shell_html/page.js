(function() {
	...
	if (window.MangogramDesktopWindowAlphaSupported === false) {
	...
	function isShellOrigin() {
		return window.location.protocol === 'https:'
			&& window.location.hostname === 'web.mangogram.org'
	...
	const api = {
		bootstrap: function(data, token) {
			...
			document.title = (data && data.title) || 'Mangogram';
	...
	Object.defineProperty(window, 'MangogramDesktopShell', {
